...
Voyager requires Node.js `>=10.0.0` (if you use node v9 the you cannot send steak in the wallet). If you have a different version of Node.js installed (e.g. Node.js `8.11 LTS`), you can use `n` to install the correct version. The following command will use `n` to install it alongside your current version of Node.js.
